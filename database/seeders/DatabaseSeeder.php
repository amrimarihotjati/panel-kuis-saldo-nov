...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Player::create([
            'id' => 1,
            'name' => 'Rian Sashaz',
            'email' => 'riansashaz@gmail.com',
            'score' => 0,
            'points' => 0,
            'points_collected' => 0,
            'referral_code' => 'abc1234567890a00',
            'status' => 1,
        ...
        Player::create([
            'id' => 2,
            'name' => 'Sani Aldi Yadi',
            'email' => 'sanialdiyadi@gmail.com',
            'score' => 0,
            'points' => 0,
            'points_collected' => 0,
            'referral_code' => 'abc1234567890a01',
            'status' => 1,
            'password' => bcrypt('password'), 
            'player_pkg' => 'com.kuis.saldo',
            'real_player' => 1,
        ...
        Player::create([
            'id' => 3,
            'name' => 'Amri Marihot Jati',
            'email' => 'amrimarihotjati@gmail.com',
            'score' => 0,
            'points' => 0,
            'points_collected' => 0,
            'referral_code' => 'abc1234567890a02',
            'status' => 1,
            'password' => bcrypt('password'), 
            'player_pkg' => 'com.kuis.saldo',
            'real_player' => 1,
        ...
        Player::create([
            ...
            'points' => 0,
            'points_collected' => 0,
            'referral_code' => 'abc1234567890a03',
            'status' => 1,
            'password' => bcrypt('password'), 
            'player_pkg' => 'com.kuis.saldo',
            'real_player' => 1,
        ...
        Player::create([
            'id' => 5,
            'name' => 'Gamma 2',
            'email' => 'gammamu@gmail.com',
            'score' => 0,
            'points' => 0,
            'points_collected' => 0,
            'referral_code' => 'abc1234567890a04',
            'status' => 1,
            'password' => bcrypt('password'), 
            'player_pkg' => 'com.kuis.saldo',
            'real_player' => 1,
        ...
        Player::create([
            ...
            'points' => 0,
            'points_collected' => 0,
            'referral_code' => 'abc1234567890a05',
            'status' => 1,
            'password' => bcrypt('password'), 
            'player_pkg' => 'com.kuis.saldo',
            'real_player' => 1,
        ...
        Withdrawal::create([
            ...
            'points' => 13000,
            'status' => 0,
            'payment_method' =>  '62d3b0bc-a56e-4225-97df-91798724e2ec',
            'payment_account' => '08123456789',
            'player_pkg' => 'com.kuis.saldo',
        ]);
        ...
        Withdrawal::create([
            ...
            'points' => 13000,
            'status' => 0,
            'payment_method' =>  '90428716-d3ae-4e44-8faa-98215566108e',
            'payment_account' => '08223456789',
            'player_pkg' => 'com.kuis.saldo',
        ]);
