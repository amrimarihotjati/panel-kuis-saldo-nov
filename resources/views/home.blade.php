...
@section('content')
    ...
    <div class="main-content">
        <div class="header">
            <div class="row">
                <div class="col-xl-3">
                    <div class="card card rounded rounded-4 shadow">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h4 class="text-primary" id="totalBaseApplication">{{ $appCount }}</h4>
                    ...
                    <div class="card card rounded rounded-4 shadow">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h4 class="text-primary" id="totalAvatar">{{ $avatarCount }}</h4>
                    ...
                    <div class="card card rounded rounded-4 shadow">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h4 class="text-primary" id="totalBadge">{{ $badgeCount }}</h4>
                                        <span class="fw-semibold">Badge</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card rounded rounded-4 shadow">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h4 class="text-primary" id="totalCategoryQuiz">{{ $categoryQuizCount }}</h4>
                                        <span class="fw-semibold">Kategori Kuis</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card rounded rounded-4 shadow">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h4 class="text-primary" id="totalBanner">{{ $bannerCount }}</h4>
                    ...
                    <div class="card card rounded rounded-4 shadow">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h4 class="text-primary" id="totalDanaKaget">{{ $dagetCount }}</h4>
                                        <span class="fw-semibold">Dana Kaget</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card rounded rounded-4 shadow">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h4 class="text-primary" id="totalRewardsAdPoint">{{ $rewardsAdPointCount }}</h4>
                                        <span class="fw-semibold">RewardsAd Point</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="content">
            <div class="card rounded rounded-4 shadow">
                <div class="card-header text-dark fw-bold d-flex justify-content-between align-items-center mt-2">
                    <div class="h5 fw-bold">Permintaan Terakhir Withdrawal<br>
                        <span class="h6 fw-semibold text-muted">Semua Aplikasi</span>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dtWithdrawalAllPlayerPkg" class="table table-bordered table-flush" style="width:100%">
                            <thead>
                                <tr>
        ...
        @include('layouts/modal/update-public-withdrawal')
    </div>
@endsection

@push('scripts')
    <script type="module">
        $('#dtWithdrawalAllPlayerPkg').DataTable({
            processing: true,
            serverSide: true,
            order: [
                [12, 'desc'],
            ...
            ajax: {
                url: "{{ route('list-withdrawal-all-pkg-pending') }}",
                data: function(d) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        var playerPkg = fromPlayer ? fromPlayer.player_pkg : 'Unknown';
                        return '<div class="d-flex align-items-center align-middle">' +
                            '<img src="' + imageUrl +
                            '" alt="" class="avatar border border-secondary border-3" style="width:40px;height:40px; margin-right: 10px;">' +
                            '<div>' +
                            '<span class="fw-bold">' + playerName + '</span></br>' +
                            '<span class="fw-semibold">' + playerEmail + '</span></br>' +
                            '<span class="fw-bold text-muted">Aplikasi : ' + playerPkg + '</span></br>' +
                            '</div>' +
                            '</div>';
                    }
                },
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return '<span class="fw-semibold">' +
                            `${svgIcon} ${formatter.format(full.amount)}` + ' ' + full.currency + '</span>';
                    }
                },
                {
                    data: 'status',
                ...
                },
                {
                    ...
                    className: 'align-middle text-center',
                    render: function(data, type, full, meta) {
                        return '<small class="fw-bold">' + full.withdraw_count + ' KALI</small>';
                    }
                },
                {
                    ...
                    className: 'align-middle text-center',
                    render: function(data, type, full, meta) {
                        return '<small class="fw-bold">' + full.withdraw_count_by_nomor + ' KALI</small>';
                    }
                },
                {
                    data: null,
        ...
        function generateFilterDropdown(paymentMethods, StatusCountWd) {
            ...
            var table = $('#dtWithdrawalAllPlayerPkg').DataTable();
