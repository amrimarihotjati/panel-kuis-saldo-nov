<div class="table-responsive p-0 m-0">
    <table id="DatatableWithdrawAllMethodPending" class="table table-bordered table-hover p-0 m-0 border" style="width:100%">
        <thead class="">
            <tr>
...
<script type="module">
    $(document).ready(function() {
        $('#DatatableWithdrawAllMethodPending').DataTable({
            processing: true,
            serverSide: true,
            order: [
                [6, 'desc'],
            ...
            ajax: {
                url: "{{ route('getDatatableWithdrawAllMethodPending') }}",
            },
            paging: false,
            searching: false,
            lengthMenu: [
