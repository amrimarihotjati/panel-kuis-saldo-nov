<div class="table-responsive p-0 m-0">
    <table id="DatatableWithdrawShoopepayMethodPending" class="table table-bordered table-hover p-0 m-0 border" style="width:100%">
        <thead class="">
            <tr>
...
<script type="module">
    $(document).ready(function() {
        $('#DatatableWithdrawShoopepayMethodPending').DataTable({
            processing: true,
            serverSide: true,
            order: [
                [6, 'desc'],
            ...
            ajax: {
                url: "{{ route('getDatatableWithdrawShoopepayPending') }}",
            },
            paging: false,
            searching: false,
            lengthMenu: [
