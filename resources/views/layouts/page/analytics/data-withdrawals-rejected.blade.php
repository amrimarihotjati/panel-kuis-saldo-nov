...
@section('title', 'Analytics Withdrawal Rejected')
        ...
        <div class="card rounded rounded-4 shadow p-3">
            <div class="card-header text-dark fw-bold mt-2 d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <div class="h5 fw-bold">Riwayat Withdrawal Rejected<br>&nbsp;</div>
                </div>
                <div class="text-end">
            ...
            <div class="card-body pt-2">
                ...
                <div class="table-responsive">
                    <table id="getDTWithdrawalRangeRejected" class="table table-bordered table-flush table-hover d-none"
                        style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle">Waktu Ditolak</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
    ...
    <script type="module">
        ...
        function initializeAnalyticsTableAndChart(appPackage, startDate, endDate) {
            $(document).ready(function() {
                $('#getDTWithdrawalRangeRejected').removeClass('d-none');

                if ($.fn.DataTable.isDataTable('#getDTWithdrawalRangeRejected')) {
                    $('#getDTWithdrawalRangeRejected').DataTable().destroy();
                }

                var baseUrl = '/analytics-data/withdrawals/rejected/' + appPackage + '/' + startDate + '/' + endDate;

                var table = $('#getDTWithdrawalRangeRejected').DataTable({
                    processing: true,
                    serverSide: true,
                    paging: true,
                    ajax: baseUrl,
