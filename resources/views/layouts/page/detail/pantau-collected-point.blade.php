...
@section('title', 'Panatu Collected Point Player')
...
<div class="main-content">
	<div class="card rounded rounded-4 shadow">
		<div class="card-header text-dark fw-bold d-flex justify-content-between align-items-center mt-2">
                <div class="h5 fw-bold">Pantau collected point<br>
                    <span class="h6 fw-semibold text-muted">
                    	Player ID: {{ $mPlayer->id }}<br>
                    	Player Package : {{ $mPlayer->player_pkg }}<br>
                    </span>
                </div>
            </div>
		<div class="card-body">
