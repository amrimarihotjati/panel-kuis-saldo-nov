...
class DansoApiController extends Controller
{
    ...
    public static function requestWithdrawPlayer(Request $request) {
        ...
        ->sum(DB::raw('ads_watched_inters + ads_watched_rewards')) ?? 0;
        ...
        if ($count_ads_total_before_withdraw < $mBaseApplication->settings_minimum_ad_withdraw) {
            return ApiFormatter::createApiFailed('Permintaan penarikan gagal dikarenakan jumlah iklan tayang kurang dari syarat penarikan. Jumlah minimum melihat iklan: ' . $mBaseApplication->settings_minimum_ad_withdraw . '. Jumlah iklan yang saat ini dilihat : ' . 
