...
class NewApiController extends Controller
{
    ...
    public static function requestWithdrawPlayer(Request $request) {
        ...
        $count_ads_total_before_withdraw = AdsCounterTemporary::where('player_id', $playerLoginId)
        ->sum(DB::raw('ads_watched_inters + ads_watched_rewards'));
        ...
        if ($count_ads_total_before_withdraw < $mBaseApplication->settings_minimum_ad_withdraw) {
            return ApiFormatter::createApiFailed('Permintaan penarikan gagal dikarenakan jumlah iklan ditonton kurang dari syarat penarikan. Jumlah minimum melihat iklan: ' . $mBaseApplication->settings_minimum_ad_withdraw . '. Jumlah iklan yang saat ini dilihat : ' . 
            $count_ads_total_before_withdraw);
        }
